int value(int mode, int value, int base, array(int) memory)
{
    if (mode == 0)
        return memory[value];
    if (mode == 1)
...
void assign(int mode, int value, int base, array(int) memory, int new)
{
    if (mode == 0)
    {
        memory[value] = new;
